...
<script src="https://dapi.kakao.com/v2/maps/sdk.js?appkey=39fcd7968ea1b9004701e015d2c75467&libraries=clusterer"></script>
...
<!--FontAwesome-->
	...
	<div id="sidebarContents">
		<!-- 검색 폼 시작 -->
			<form name="searchShop" class="searchShop" method="get" action="/mapList/searchShop">
			<!-- 검색 유형 선택 -->
			...
			<c:choose>
				<c:when test="${param.cate ne null and param.cate != 0}">
					<div id="keywordInput" style="display: none;">
						<span> <input class="search-keyword" type="text"
			...
			<input class="btn-search" type="button" value="검색"
			onclick="searchCheck()">
		</form>
